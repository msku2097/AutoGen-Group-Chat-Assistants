...
gpt4_config = {"config_list": config_list, "temperature":0.3, "seed": 53}
...
class MyConversableAgent(autogen.ConversableAgent):
    ...
    async def a_get_human_input(self, prompt: str) -> str:
        global input_future
        print('AGENT!!')  # or however you wish to display the prompt
...
user_proxy = MyConversableAgent(
   ...
   default_auto_reply="Approved, create the code", 
...
chat_interface.send("Tell me you story Sir!", user="System", respond=False)
